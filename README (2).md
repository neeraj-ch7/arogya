...
> *UI screenshots coming soon — visit the [Live Demo](https://arogya-azure.vercel.app/) to explore the platform.*

| Dashboard | Symptom Checker | Health Records |
|---|---|---|
| *(screenshot)* | *(screenshot)* | *(screenshot)* |

| QR Health Passport | Mood Tracker | Emergency Support |
|---|---|---|
| *(screenshot)* | *(screenshot)* | *(screenshot)* |
